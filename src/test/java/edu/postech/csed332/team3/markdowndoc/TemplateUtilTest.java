...
class TemplateUtilTest {
    ...
    @Test
    void classLabelTest() {
        assertEquals("<div><div class=\"pkg\">com.example.package</div><h1>MyClass</h1><div><strong>extends</strong> <a id=\"c-MyParentClass\">MyParentClass</a></div><div><strong>implements</strong> <a id=\"c-MyInterface\">MyInterface</a></div><div><strong>implements</strong> <a id=\"c-MyInterface2\">MyInterface2</a></div></div>",
                templateUtil.classLabel("MyClass", "com.example.package", "MyParentClass", List.of("MyInterface", "MyInterface2")));
    }
    ...
    @Test
    void fieldTest() {
        assertEquals("<tr><td data-type=\"int\"><h5>Field</h5><h3><a id=\"f-myInt\">int myInt</a></h3><p>An HTML description</p></td></tr>",
                templateUtil.field("myInt", "int", "<p>An HTML description</p>", null));
    }

    @Test
    void methodTest() {
        assertEquals("<tr><td data-type=\"void\"><h5>Method</h5><h3><a id=\"m-myMethod\">public static void myMethod</a></h3><p>An HTML description</p><p><strong class=\"alert\">@param</strong> var1 param<br><strong class=\"alert\">@param</strong> var2 param 2<br></p></td></tr>",
                templateUtil.method("myMethod", "void", "public static", "<p>An HTML description</p>", List.of("@param var1 param", "@param var2 param 2")));
    }
